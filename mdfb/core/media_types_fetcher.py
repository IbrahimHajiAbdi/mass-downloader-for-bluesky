...
class MediaTypesFetcher:
    def __init__(self, did: str, feed_type: str, db: Database, media_types: list[str], logger: logging.Logger | None = None, num_threads: int = DEFAULT_THREADS, restore: bool = False):
        self.did = did
