                ...
                "return": [
                    {
                        ...
                        "user_post_uri": ["at://did:plc:u6iyyil77bqv5fknwauj3tfk/app.bsky.feed.like/3lr4iyr7fgu2q"],
                        "feed_type": ["like"],
                        "poster_post_uri": "at://did:plc:vpkdwwdia5etkdsuvsewtlws/app.bsky.feed.post/3lqx7wzy7c227",
                        "author": {
                            "did": "did:plc:vpkdwwdia5etkdsuvsewtlws",
                            "handle": "inkpixels.bsky.social",
                            "associated": {
                                "chat": {
                                    "allow_incoming": "following",
                            ...
                            "avatar": "https://cdn.bsky.app/img/avatar/plain/did:plc:vpkdwwdia5etkdsuvsewtlws/bafkreiauvzci74nrfoxhkfgd3mo6h75ejmzpxpyxlkbg2d5shflhy2ugmu@jpeg",
                            "created_at": "2023-08-20T15:22:50.198Z",
                            "display_name": "ink",
                            "labels": [],
                            "viewer": None,
                            "py_type": "app.bsky.actor.defs#profileViewBasic",
                        },
                        "cid": "bafyreidhuc5hv3iiq26e6citq2d77xl5gwsf22mp6qpwtl73hdkjqy3jsa",
                        "indexed_at": "2025-06-06T16:11:06.061Z",
                        "record": {
                            "created_at": "2025-06-06T16:11:02.304Z",
                            "text": "11 colors, pixelart",
                            "embed": {
                                "images": [
                                    {
                                        "alt": "",
                                        "image": {
                                            ...
                                            "size": 631615,
                                            "ref": {
                                                "link": "bafkreienkhaa7gtudrria37tznq4bvwtnwmuavtizqoqlq5dxesbo4yhei"
                                            },
                                            "py_type": "blob",
                                        },
                                        "aspect_ratio": {
                        ...
                        "uri": "at://did:plc:vpkdwwdia5etkdsuvsewtlws/app.bsky.feed.post/3lqx7wzy7c227",
                        "embed": {
                            "images": [
                                {
                                    "alt": "",
                                    "fullsize": "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:vpkdwwdia5etkdsuvsewtlws/bafkreienkhaa7gtudrria37tznq4bvwtnwmuavtizqoqlq5dxesbo4yhei@jpeg",
                                    "thumb": "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:vpkdwwdia5etkdsuvsewtlws/bafkreienkhaa7gtudrria37tznq4bvwtnwmuavtizqoqlq5dxesbo4yhei@jpeg",
                                    "aspect_ratio": {
                                        "height": 570,
                                        "width": 960,
                                        "py_type": "app.bsky.embed.defs#aspectRatio",
                        ...
                        "repost_count": 940,
                        "threadgate": {
                            "cid": "bafyreig7tcabkvv5erg4subslzkwmrk5ge6zmjz4k7re2dhuldf3wlksfa",
                            "lists": [],
                            "record": {
                                "created_at": "2025-06-07T09:11:01.662Z",
                                "post": "at://did:plc:vpkdwwdia5etkdsuvsewtlws/app.bsky.feed.post/3lqx7wzy7c227",
                                "allow": None,
                                "hidden_replies": [
                                    "at://did:plc:bkd55nd44ddocqyv5cbxa3hq/app.bsky.feed.post/3lqyt2fow6s2j"
                                ],
                                "py_type": "app.bsky.feed.threadgate",
                            },
                            "uri": "at://did:plc:vpkdwwdia5etkdsuvsewtlws/app.bsky.feed.threadgate/3lqx7wzy7c227",
                ...
                "expected": [
                    {
                        ...
                        "display_name": "ink",
                        "media_type": ["image"],
                        "images_cid": ["bafkreienkhaa7gtudrria37tznq4bvwtnwmuavtizqoqlq5dxesbo4yhei"],
                        "mime_type": "image/jpeg",
                    }
                ],
            },
            "deleted": {"return": [], "expected": []},
        }

    @pytest.fixture(scope="class")
    def successful_response(self, api_response):
        with (
            patch("atproto_client.namespaces.sync_ns.AppBskyFeedNamespace.get_posts") as mock_api_response,
...
class TestGetPostDetails:
    ...
    def api_response_retry_then_succeed(self):
        ...
        with patch("atproto_client.namespaces.sync_ns.AppBskyFeedNamespace.get_posts") as mock_api_response:
            mock_api_response.side_effect = [AtProtocolError(), success_data]
    ...
    def api_response_retry_succeeds(self):
        success_data = ["success!"]
        with patch("atproto_client.namespaces.sync_ns.AppBskyFeedNamespace.get_posts") as mock_api_response:
            mock_api_response.side_effect = [success_data]
            yield {"mock": mock_api_response, "success_data": success_data}
...
class TestFetchPostDetailsUtils:
    def test_extract_media_image(self, mocker):
            ...
            "posts": [
                {
                    "author": {
                        ...
                        "handle": "bsky.app",
                        "associated": {
                            "chat": {"allow_incoming": "none", "py_type": "app.bsky.actor.defs#profileAssociatedChat"},
                            "feedgens": None,
                            "labeler": None,
                            "lists": None,
                            "starter_packs": None,
                    ...
                    "cid": "bafyreigp3wgf36lhnb73plsy4xyfpaub5xvrntmmh4lga2z75reld3qnna",
                    "indexed_at": "2024-11-18T02:51:34.738Z",
                    "record": {
                        "created_at": "2024-11-18T02:51:26.625Z",
                        "text": "me watching Bluesky's user count grow by another million in a day\n\nhello and welcome to all 19M of you! 🥳",
                        "embed": {
                            "images": [
                                {
                                    "alt": "Kris Jenner looking at a computer",
                                    "image": {
                                        "mime_type": "image/jpeg",
                                        "size": 232606,
                                        "ref": {"link": "bafkreiddd7cus33yyfwxcjrzk77ka3zldjzt22wbvoimduwn2viuf2qdtq"},
                                        "py_type": "blob",
                                    },
                                    "aspect_ratio": {
                                        "height": 487,
                    ...
                    "uri": "at://did:plc:z72i7hdynmk6r22z27h6tvur/app.bsky.feed.post/3lb6vz4ms6c25",
                    "embed": {
                        "images": [
                            {
                                "alt": "Kris Jenner looking at a computer",
                                "fullsize": "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:z72i7hdynmk6r22z27h6tvur/bafkreiddd7cus33yyfwxcjrzk77ka3zldjzt22wbvoimduwn2viuf2qdtq@jpeg",
                                "thumb": "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:z72i7hdynmk6r22z27h6tvur/bafkreiddd7cus33yyfwxcjrzk77ka3zldjzt22wbvoimduwn2viuf2qdtq@jpeg",
                                "aspect_ratio": {
                                    "height": 487,
                                    "width": 702,
                                    "py_type": "app.bsky.embed.defs#aspectRatio",
        ...
        assert result == {
            "media_type": ["image"],
            "images_cid": ["bafkreiddd7cus33yyfwxcjrzk77ka3zldjzt22wbvoimduwn2viuf2qdtq"],
            "mime_type": "image/jpeg",
        }
    ...
    def test_extract_media_video(self, mocker):
            ...
            "posts": [
                {
                    ...
                    "cid": "bafyreigah7oevnzroay2ve56w7pd3atscamiekwqbmj3kl66mvqsuydtwe",
                    "indexed_at": "2024-11-15T00:53:48.256Z",
                    "record": {
                        "created_at": "2024-11-15T00:53:46.785Z",
                        "text": "it's official — 1,000,000 people have joined Bluesky in just the last day!!! \n\nwelcome and thank you for being here 🥳",
                        "embed": {
                            "video": {
                                "mime_type": "video/mp4",
                                "size": 1787532,
                                "ref": {"link": "bafkreic5qzdlpdt6gqakxzx27lsp6phmltk2fv6bpyfleoumo4nxytvleq"},
                                "py_type": "blob",
                            },
                            "alt": "Barbie smiling, clapping, and jumping up and down",
                            "aspect_ratio": {
                                "height": 640,
                                "width": 1280,
                                "py_type": "app.bsky.embed.defs#aspectRatio",
                    ...
                    "embed": {
                        "cid": "bafkreic5qzdlpdt6gqakxzx27lsp6phmltk2fv6bpyfleoumo4nxytvleq",
                        "playlist": "https://video.bsky.app/watch/did%3Aplc%3Az72i7hdynmk6r22z27h6tvur/bafkreic5qzdlpdt6gqakxzx27lsp6phmltk2fv6bpyfleoumo4nxytvleq/playlist.m3u8",
                        "alt": "Barbie smiling, clapping, and jumping up and down",
                        "aspect_ratio": {"height": 640, "width": 1280, "py_type": "app.bsky.embed.defs#aspectRatio"},
                        "thumbnail": "https://video.bsky.app/watch/did%3Aplc%3Az72i7hdynmk6r22z27h6tvur/bafkreic5qzdlpdt6gqakxzx27lsp6phmltk2fv6bpyfleoumo4nxytvleq/thumbnail.jpg",
        ...
        assert result == {
            "media_type": ["video"],
            "video_cids": "bafkreic5qzdlpdt6gqakxzx27lsp6phmltk2fv6bpyfleoumo4nxytvleq",
            "mime_type": "video/mp4",
        }
    ...
    def test_merge_uri_chunk_to_records(self, mocker):
        ...
        assert result == [
            {"uri": "example_uri_1", "poster_post_uri": "example_uri_1"},
            {"uri": "example_uri_2", "poster_post_uri": "example_uri_2"},
        ]
