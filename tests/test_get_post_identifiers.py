...
class TestGetPostIdentifiers:
        ...
        mock_fetch_post_response = [
            {
                ...
                "user_post_uri": ["at://did:plc:u6iyyil77bqv5fknwauj3tfk/app.bsky.feed.like/3lrjgrrwsdg2z"],
                "feed_type": ["like"],
                "poster_post_uri": "at://did:plc:xlqcxpk53spbhlypj6wmvvke/app.bsky.feed.post/3ld6bzuenjs2a",
                "author": {
                    ...
                    "handle": "popbase.tv",
                    "associated": {
                        "chat": {"allow_incoming": "all", "py_type": "app.bsky.actor.defs#profileAssociatedChat"},
                        "feedgens": None,
                        "labeler": None,
                        "lists": None,
                        "starter_packs": None,
                    ...
                    "created_at": "2024-09-03T22:04:10.910Z",
                    "display_name": "Pop Base",
                    "labels": [],
                    "viewer": None,
                    "py_type": "app.bsky.actor.defs#profileViewBasic",
                },
                "cid": "bafyreifp4vomoqhxritmilksydl4iixlnqnmwhau4nnprs7dvl4xy6gmqi",
                "indexed_at": "2024-12-13T07:44:21.553Z",
                "record": {
                    "created_at": "2024-12-13T07:44:19.946Z",
                    "text": "Bluesky has passed a milestone of 25 MILLION users.",
                    "embed": {
                        "images": [
                            {
                                "alt": "Landscape image of the Bluesky logo.",
                                "image": {
                                    "mime_type": "image/jpeg",
                                    "size": 82140,
                                    "ref": {"link": "bafkreifma6v5wt6ml4srjfzd3ayd743kg2kjwvu2rnursohhjffuypqhhu"},
                                    "py_type": "blob",
                                },
                                "aspect_ratio": {
                                    "height": 683,
                ...
                "embed": {
                    "images": [
                        {
                            "alt": "Landscape image of the Bluesky logo.",
                            "fullsize": "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:xlqcxpk53spbhlypj6wmvvke/bafkreifma6v5wt6ml4srjfzd3ayd743kg2kjwvu2rnursohhjffuypqhhu@jpeg",
                            "thumb": "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:xlqcxpk53spbhlypj6wmvvke/bafkreifma6v5wt6ml4srjfzd3ayd743kg2kjwvu2rnursohhjffuypqhhu@jpeg",
                            "aspect_ratio": {
                                "height": 683,
                                "width": 1290,
                                "py_type": "app.bsky.embed.defs#aspectRatio",
            ...
            {
                "user_did": "did:plc:u6iyyil77bqv5fknwauj3tfk",
                "user_post_uri": ["at://did:plc:u6iyyil77bqv5fknwauj3tfk/app.bsky.feed.like/3lrjgroyvx42x"],
                "feed_type": ["like"],
                "poster_post_uri": "at://did:plc:vc7f4oafdgxsihk4cry2xpze/app.bsky.feed.post/3lbxe3z66hk2e",
                "author": {
                    "did": "did:plc:vc7f4oafdgxsihk4cry2xpze",
                    "handle": "jcsalterego.bsky.social",
                    "associated": {
                        "chat": {"allow_incoming": "following", "py_type": "app.bsky.actor.defs#profileAssociatedChat"},
                        "feedgens": None,
                        "labeler": None,
                        "lists": None,
                        "starter_packs": None,
                    ...
                    "avatar": "https://cdn.bsky.app/img/avatar/plain/did:plc:vc7f4oafdgxsihk4cry2xpze/bafkreicwxwecqiko2rwwln5y3fqqb2zx6wfg5rxf5r7lukakkq2slqy5hy@jpeg",
                    "created_at": "2023-04-23T20:11:04.375Z",
                    "display_name": "Jerry Chen",
                    "labels": [
                        {
                ...
                "cid": "bafyreiabo7kerzlewo33l4y6qqdwgmpjhrpi6yagf7fvzn2tepnstn2lie",
                "indexed_at": "2024-11-27T20:07:29.966Z",
                "record": {
                    "created_at": "2024-11-27T20:07:29.775Z",
                    "text": "no i will not pay $29.99/mo to know which one of my posts made it into the bsky slack. i will pay much, much more",
                    "embed": None,
                    "entities": None,
                    "facets": None,
                    "labels": None,
                ...
                "repost_count": 45,
                "threadgate": {
                    "cid": "bafyreigo3mzmgz665jqzngjjuxm3hxnmbvkkqs37lxvxt722ycfjv73dbq",
                    "lists": [],
                    "record": {
                        "created_at": "2024-11-28T18:04:38.197Z",
                        "post": "at://did:plc:vc7f4oafdgxsihk4cry2xpze/app.bsky.feed.post/3lbxe3z66hk2e",
                        "allow": None,
                        "hidden_replies": ["at://did:plc:3cbrfca7okiytbjbpdu3cmgz/app.bsky.feed.post/3lbznkdbosk2v"],
                        "py_type": "app.bsky.feed.threadgate",
                    },
                    "uri": "at://did:plc:vc7f4oafdgxsihk4cry2xpze/app.bsky.feed.threadgate/3lbxe3z66hk2e",
        ...
        expected = [
            {
                ...
                "display_name": "Pop Base",
                "media_type": ["image"],
                "images_cid": ["bafkreifma6v5wt6ml4srjfzd3ayd743kg2kjwvu2rnursohhjffuypqhhu"],
                "mime_type": "image/jpeg",
            }
        ]
        with (
    ...
    def test_get_post_identifiers_liked(self, get_post_api_response):
        ...
        get_post_api_response["mock_api_response"].assert_called_once_with(
            {"collection": "app.bsky.feed.like", "repo": "did:example:1234", "limit": 2, "cursor": ""}
        )

    def test_get_post_identifiers_no_likes(self):
        mock_json_response = {"records": []}
        mock_response = MagicMock()
        mock_response.model_dump_json.return_value = json.dumps(mock_json_response)
        with patch("atproto_client.namespaces.sync_ns.ComAtprotoRepoNamespace.list_records") as mock_api_response:
            mock_api_response.return_value = mock_response
