...
class TestDownloadBlobsUtils:
    ...
    def test_make_base_filename(self):
        ...
        assert (
            result == f"{filename_options.get('RKEY')}_{filename_options.get('TEXT')}_{filename_options.get('HANDLE')}"
        )
...
class TestDownloadBlobs:
    ...
    def successful_download_blobs(self):
        mock_post = [
            {
                ...
                "response": {
                    ...
                    "author": {
                        ...
                        "avatar": "https://cdn.bsky.app/img/avatar/plain/did:plc:3eatnvb2dim4l7fiwln5wow6/bafkreifz2jzlibiyldp75uhdi4xhlpww6khmkt5brpj2jif274kocrv3xq@jpeg",
                        "created_at": "2024-10-20T14:50:10.507Z",
                        "display_name": "daily bunnies 🐇✨",
                        "labels": [],
                        "viewer": None,
                        "py_type": "app.bsky.actor.defs#profileViewBasic",
                    },
                    "cid": "bafyreib3qtxun7gvvpjaxk666xxvkltu2oyyghekziswhwtmutz6xz2vh4",
                    "indexed_at": "2025-06-06T14:07:49.256Z",
                    "record": {
                        "created_at": "2025-06-06T14:07:44.486Z",
                        "text": "",
                        "embed": {
                            "images": [
                                {
                                    "alt": "A small, white bunny stands on its hind legs, peering out a window. Lush green trees are visible outside.",
                                    "image": {
                                        "mime_type": "image/jpeg",
                                        "size": 659942,
                                        "ref": {"link": "bafkreiamy7yinrdcqrqtka4xwhhkbcblv4zxudjlupslnuamzm6tbxofze"},
                                        "py_type": "blob",
                                    },
                                    "aspect_ratio": {
                                        "height": 1440,
                    ...
                    "uri": "at://did:plc:3eatnvb2dim4l7fiwln5wow6/app.bsky.feed.post/3lqwz2kuzg22s",
                    "embed": {
                        "images": [
                            {
                                "alt": "A small, white bunny stands on its hind legs, peering out a window. Lush green trees are visible outside.",
                                "fullsize": "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:3eatnvb2dim4l7fiwln5wow6/bafkreiamy7yinrdcqrqtka4xwhhkbcblv4zxudjlupslnuamzm6tbxofze@jpeg",
                                "thumb": "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:3eatnvb2dim4l7fiwln5wow6/bafkreiamy7yinrdcqrqtka4xwhhkbcblv4zxudjlupslnuamzm6tbxofze@jpeg",
                                "aspect_ratio": {
                                    "height": 1440,
                                    "width": 1080,
                                    "py_type": "app.bsky.embed.defs#aspectRatio",
        ...
        with patch("tqdm.tqdm") as mock_tdqm, patch("mdfb.utils.database.insert_post"):
            yield {
                "post": mock_post,
    ...
    def test_download_blob(self, successful_download_blobs, temp_dir, successful_get_blob):
        download_blobs.download_blobs(
            successful_download_blobs["post"], temp_dir, successful_download_blobs["mock_tdqm"]
        )
        ...
        with open(expected_file_path_json) as f_json:
